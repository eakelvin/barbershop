        ...
        <div className="container">
            <div className="mt-5 row justify-content-between">
                <div className="col-sm-6 col-md-4 mx-auto text-center">
                    <img className="rounded-circle mb-4" loading="lazy" src="./src/assets/p1.avif" alt="Profile" height="100" width="100" />
                    <p className="">
                ...
                <div className="col-sm-6 col-md-4 mx-auto text-center">
                    <img className="rounded-circle mb-4" loading="lazy" src="./src/assets/p-2.avif" alt="Profile" height="100" width="100" />
                    <p className="">
                ...
                <div className="col-sm-6 col-md-4 mx-auto text-center">
                    <img className="rounded-circle mb-4" loading="lazy" src="./src/assets/p-3.avif" alt="Profile" height="100" width="100" />
                    <p className="">
